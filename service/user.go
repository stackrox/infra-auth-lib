...
func (s *userImpl) Access() map[string]middleware.Access {
	return map[string]middleware.Access{
		"/proto.api.v1.UserService/Token":       middleware.Authenticated,
		"/proto.api.v1.UserService/CreateToken": middleware.Admin,
		"/proto.api.v1.UserService/Whoami":      middleware.Anonymous,
	}
}
